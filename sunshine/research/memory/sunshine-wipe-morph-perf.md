...
with the recompose still crawling after Mario has spawned and is running around normally.
...
so every fan lands up to ±107px from the rect it just blacked out. Only copy-based
